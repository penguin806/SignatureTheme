...
?>
<footer class="mastfoot signature-adler signature-amor" style="background: <?php echo esc_attr($signature_options['foot_bg_color']);?>">
  <div class="container-fluid">
    ...
    <div class="row">
          ...
          <article class="credits col-md-5  text-left">
              <p class="font3 dark">
                <?php 
                  echo wp_kses($signature_options['amor-footer-content'], array(
                                    'a' => array(
                                        'href' => array(),
                                        'title' => array(),
                                        'target' => array()
