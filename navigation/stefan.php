...
?>
    ...
    <header class="masthead signature-stefan fullheight" style="background: <?php echo esc_attr($signature_options['stefan-nav-bg-color']);?>">
      <div class="valign">
        <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="main-logo img-responsive" src="<?php echo esc_url($signature_options['stefan-nav-logo']['url']); ?>"/></a>
      </div>
      <article class="notification-icon-wrap">
            <div class="menu-notification signature-stefan">
    ...
    <nav class="mastnav signature-stefan fullheight" style="background: <?php echo esc_attr($signature_options['stefan-nav-bg-color']);?>">
      <div class="valign">
          ...
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-stefan default-wp-nav',
                'echo'            => true,
...
function signature_stefan_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-stefan '.esc_attr($nav_class).'">' . "\n";
