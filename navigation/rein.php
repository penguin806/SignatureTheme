...
?>
    ...
    <header class="masthead signature-rein" style="background: <?php echo esc_attr($signature_options['rein-nav-bg-color']);?>">
      <div class="container">
        <div class="row">
          <article class="col-md-6 text-left">
            <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="main-logo img-responsive" src="<?php echo esc_url($signature_options['rein-nav-bar-logo']['url']); ?>"/></a>
          </article>
    ...
    <nav class="mastnav signature-rein fullheight">
      ...
      <div class="mastnav-inner-right fullheight white-bg">
        <div class="valign">
          ...
          <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="main-logo img-responsive" src="<?php echo esc_url($signature_options['rein-nav-logo']['url']); ?>"/></a>
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-rein default-wp-nav',
                'echo'            => true,
...
function signature_rein_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-rein '.esc_attr($nav_class).'">' . "\n";
            ...
            if($has_sub_menu == 1)
            {
              ...
              foreach ( $menunu as $submenu )
              {
                if($submenu->menu_item_parent == $men->ID)
                {
                  ...
                  $return .= '<li><a href="'. esc_url($href) .'" '.esc_attr($link_target).' class="font3 dark '.esc_attr($identifyClass).'">'. esc_html($submenu->title) .'</a></li>';
