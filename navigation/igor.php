      ...
      <div class="container-fluid"> 
        <div class="row">
            ...
            <article class="col-md-6">
              <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="nav-logo img-responsive" src="<?php echo esc_url($signature_options['igor-nav-bar-logo']['url']); ?>"/></a>
            </article>
...
function signature_igor_nav(){
  ...
  {
    $return = '<h5 class="clearfix white font2 '.esc_attr($nav_class).'">'.esc_html__('Please configure the navigation menu','signature').'</h5>';
  }
  else
  {
