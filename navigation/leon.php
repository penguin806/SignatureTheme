...
?>
    ...
    <nav class="mastnav signature-leon fullheight" style=" background-color:<?php echo esc_attr($signature_options['leon-nav-bg-color']);?>; background-image: url(<?php echo esc_url($signature_options['leon-nav-bg-img']['url']);?>);">
      <div class="menu-close-notification">
          <a class="font3bold" href="#"><span class="ion-android-close dark"></span></a>
      </div>
      <div class="valign">
          ...
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-leon default-wp-nav',
                'echo'            => true,
...
function signature_leon_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-leon '.esc_attr($nav_class).'">' . "\n";
