...
?>
    <div class="signature-theo sticky-panel sticky-panel-top"></div>
    <div class="signature-theo sticky-panel sticky-panel-right"></div>
    <div class="signature-theo sticky-panel sticky-panel-bottom"></div>
    <div class="signature-theo sticky-panel sticky-panel-left"></div>


    <nav class="mastnav signature-theo img-bg text-center" style="background-color: <?php echo esc_attr($signature_options['theo-nav-bg-color']);?>; background-image:url(<?php echo esc_url($signature_options['theo-nav-bg-img']['url']);?>);">
        ...
        <div class="valign">
            ...
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-theo default-wp-nav',
                'echo'            => true,
    ...
    <!-- Header -->
    <header class="masthead signature-theo">
      <div class="container-fluid"> 
        <div class="row">
          
            <article class="col-md-6">
              <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="main-logo img-responsive" src="<?php echo esc_url($signature_options['theo-nav-logo']['url']); ?>"/></a>
            </article>
            <article class="col-md-6 notification-icon-wrap">
                  <div class="menu-notification">
                      <a class="font3bold" href="#"><span class="ion-navicon black"></span></a>
                  </div>
            </article>
...
function signature_theo_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-theo '.esc_attr($nav_class).'">' . "\n";
