...
?>
    ...
    <header class="masthead signature-nemo" style="background: <?php echo esc_attr($signature_options['nemo-nav-bar-bg-color']);?>">
      <div class="container-fluid"> 
        <div class="row">
          
            <article class="col-md-6">
              <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="nav-logo img-responsive" src="<?php echo esc_url($signature_options['nemo-nav-bar-logo']['url']); ?>"/></a>
            </article>
    ...
    <nav class="mastnav signature-nemo fullheight" style=" background-color:<?php echo esc_attr($signature_options['nemo-nav-bg-color']);?>; background-image: url(<?php echo esc_url($signature_options['nemo-nav-bg-img']['url']);?>);">
          ...
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-nemo default-wp-nav',
                'echo'            => true,
...
function signature_nemo_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-nemo '.esc_attr($nav_class).'">' . "\n";
