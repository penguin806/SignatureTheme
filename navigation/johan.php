...
?>
    ...
    <header class="masthead signature-johan" style="background: <?php echo esc_attr($signature_options['johan-nav-bar-bg-color']);?>">
      <div class="container"> 
        <div class="row">
          
            <article class="col-md-6">
              <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="nav-logo img-responsive" src="<?php echo esc_url($signature_options['johan-nav-bar-logo']['url']); ?>"/></a>
            </article>
    ...
    <nav class="mastnav signature-johan clearfix" style="background: <?php echo esc_attr($signature_options['johan-nav-bg-color']);?>">
          ...
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-johan default-wp-nav',
                'echo'            => true,
...
function signature_johan_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-johan '.esc_attr($nav_class).'">' . "\n";
