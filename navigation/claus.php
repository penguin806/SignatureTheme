...
?>
    ...
    <!-- Header -->
    <header class="masthead signature-claus" style="background: <?php echo esc_attr($signature_options['claus-nav-bg-color']);?>">
      <div class="masthead-inner">
        <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="nav-logo img-responsive" src="<?php echo esc_url($signature_options['claus-nav-logo']['url']); ?>"/></a>
          ...
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-claus default-wp-nav',
                'echo'            => true,
...
function signature_claus_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-claus '.esc_attr($nav_class).'">' . "\n";
