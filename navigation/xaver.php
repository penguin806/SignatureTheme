...
?>
    ...
    <header class="masthead signature-xaver">
      <div class="container-fluid"> 
        <div class="row">
          
            <article class="col-md-6">
              <a href="<?php echo esc_url(home_url( '/' )); ?>">
                <img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="main-logo img-responsive" src="<?php echo esc_url($signature_options['xaver-nav-logo']['url']); ?>"/>
              </a>
            </article>
    ...
    <nav class="mastnav signature-xaver img-bg" style="background-color: #292929; background-image:url(<?php echo esc_url($signature_options['xaver-nav-bg-img']['url']);?>);">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <?php
                  if($signature_options['navigation_opt'] == "0")
                  {
                    $nav_args = array(
                      ...
                      'container'       => false,
                      'menu_class'      => 'main-menu signature-xaver default-wp-nav',
                      'echo'            => true,
              ...
              <article class="col-md-6 text-right">
                      <a href="<?php echo esc_url(home_url( '/' )); ?>">
                        <img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="menu-logo img-responsive" src="<?php echo esc_url($signature_options['xaver-nav-logo']['url']); ?>"/>
                      </a>
                      <div class="clearfix"></div>
                      <div class="menu-credits text-right">
                          <p class="font3 white">
                            <?php 
                              echo wp_kses($signature_options['xaver-nav-content'], array(
                                          'a' => array(
                                              'href' => array(),
                                              'title' => array(),
                                              'target' => array()
...
function signature_xaver_nav(){
  ...
  {
    $return = '<h5 class="clearfix font3bold white '.esc_attr($nav_class).'">'.esc_html__('Please configure the navigation menu','signature').'</h5>';
  }
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-xaver '.esc_attr($nav_class).'">' . "\n";
