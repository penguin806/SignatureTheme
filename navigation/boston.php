...
?>
    ...
    <header class="masthead signature-boston">
      <div class="container-fluid"> 
        <div class="row">
          
            <article class="col-md-6">
              <a href="<?php echo esc_url(home_url( '/' )); ?>"><img alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>" class="nav-logo img-responsive" src="<?php echo esc_url($signature_options['boston-nav-bar-logo']['url']); ?>"/></a>
            </article>
    ...
    <nav class="mastnav signature-boston fullheight" style=" background-color:<?php echo esc_attr($signature_options['boston-nav-bg-color']);?>; background-image: url(<?php echo esc_url($signature_options['boston-nav-bg-img']['url']);?>);">
          ...
          <?php
            if($signature_options['navigation_opt'] == "0")
            {
              $nav_args = array(
                ...
                'container'       => false,
                'menu_class'      => 'main-menu signature-boston default-wp-nav',
                'echo'            => true,
...
function signature_boston_nav(){
  ...
  else
  {
    ...
    else
    {
      ...
      $return = '<ul class="main-menu signature-boston '.esc_attr($nav_class).'">' . "\n";
      ...
      foreach ( $menunu as $i => $men ){
        if($men->menu_item_parent == '0')
        {
            ...
            $return .='<li class="white '.esc_attr($parent_class).'">';
